...
<!--Add Job Position at Admin Side -->
<!DOCTYPE html>
<html>
<head>
...
padding-right: 0px; margin: 0 auto; width: 1200px;">
 ...
 <main id="addjobposition_admin_main">
  <div class="wrapper">
    ...
    <div class="container">
      <h1 class="text-center">Add Job Post</h1>
      <div class="container">
        ...
        if(isset($_POST['addpost']))
        {
               ...
               $job_type = $_POST['job_type'];
                ...
                if(!empty($_POST['job_title']) && !empty($_POST['location_name']) && !empty($_POST['skill_requirements']) && !empty($_POST['job_requirements']) && !empty($_POST['description']) && !empty($_POST['salary']) && !empty($_POST['job_type']))
                {
                   ...
                   $c = $j->addJobPosition($job_title, $location_name, $skill_requirements, $job_requirements, $description, $salary, $job_type, $dbcon); //call to addJobPosition method

                   //if all the field is filled then redirect to listJobPostsAdmin.php page 
                   if($c)
                   {
                  ...
                  //if not, then it will appear a message
                  else 
                   {
                       echo "problem adding a job post";
                   }
    ...
    <form action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">        
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class='btn btn-primary' name="addpost" value="Submit">Submit</button>
          </div>
        </div>
    </form>
   </div>
